...
1. In Visual Studio, right-click on the BlazorAI_MCP.AppHost project in the Solution Explorer and select "Manage User Secrets".
...
3. Once installed, Open the `Program.cs` file in the BlazorAI_MCP.AppHost project.
